...
```{r}
# Hellinger transformation (alternative to the chord transformation)
...
`MVPARTwrap` adds tools that make the tree easier to interpret ecologically: which species are driving the split at each node (discriminant species), and how the total species variance is partitioned across the tree.
