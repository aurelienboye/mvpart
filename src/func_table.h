...
extern void anovass   (int n,     double *y[], double *value, double *risk,
                                  double *wt);
extern void mrtss   (int n,     double *y[], double *value, double *risk,
                                  double *wt);
extern void distss   (int n,     double *y[], double *value, double *risk,
                                  double *wt);                                  
...
extern void mrt(    int n,    double *y[],     FLOAT *x,     int nclass, 
                      int edge, double *improve, FLOAT *split, int *csplit, 
                      double myrisk,             double *wt);
extern void dist(    int n,    double *y[],     FLOAT *x,     int nclass, 
                      int edge, double *improve, FLOAT *split, int *csplit, 
                      double myrisk,             double *wt);                      
...
static struct {
    ...
    void   (*choose_split)(int n, double *y[], FLOAT *x, int nclass,
                            ...
                            int *csplit, double myrisk, double *wt);
